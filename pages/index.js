          ...
          <div className="container px-4 mx-auto">
            <div className="md:max-w-5xl mx-auto mb-16 text-left">
              ...
              <Link className="block mb-6 overflow-hidden rounded-md text-left bg-white" href="#">
                <img className="w-full h-[200px] object-cover  rounded-xl"  src="images/log.png" />
                </Link>
                <div className="flex-1 p-3">
                  <div className="flex flex-col justify-between h-full">
                    <div className="flex-initial mb-8">
                      <p className="mb-3 text-xs text-gray-500 font-semibold">1min ago</p>
                      <Link className="--no-underline group inline-block mb-4" href="#"> A small business is only as good as its tools and it is
                  totally true.</Link>
                    </div>
              ...
              <Link className="block mb-6 overflow-hidden rounded-md text-left " href="#">
                <img className="w-full h-[200px] object-cover  rounded-xl"  src="images/logo20.png" />
                </Link>
                <div className="flex-1 p-3">
                  <div className="flex flex-col justify-between h-full">
                    <div className="flex-initial mb-8">
